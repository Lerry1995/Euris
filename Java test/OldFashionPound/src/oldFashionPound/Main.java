	...
	public static void main(String[] args){
		try (Scanner tastiera = new Scanner(System.in)) {
			...
			case 1: {
				...
				System.out.println("La somma dei prezzi é : " + Calcolatore.somma(p, p2));
				break;
			}
			case 2: {
				...
				System.out.println("La sottrazione dei prezzi é : " + Calcolatore.sottrazione(p, p2));
				break;
			}
			...
			case 4: {
				...
				do {
					System.out.println("il volore " + div +" inserito non è > 0; \n"
			...
			default:
				System.out.println("Il valore inserito non è valido, riavviare il programma");
			}
		} catch (Exception e) {
			System.out.println("Il valore inserito non è valido, riavviare il programma");
		}
